...
class Formel:
    class Solver:
        ...
        def solve_to_i(self):
            return [(self.formel.a.wert**self.formel.z.wert) * (self.formel.b.wert**self.formel.y.wert)
                    * (self.formel.c.wert**self.formel.x.wert) + self.formel.d.wert * self.formel.e.wert
                    * self.formel.f.wert + self.formel.g.wert, self.get_dicts()]

        def solve_to_a(self):
            return [((self.formel.i.wert - self.formel.d.wert * self.formel.e.wert * self.formel.f.wert
                      - self.formel.g.wert)/((self.formel.b.wert ** self.formel.y.wert)
                                             * (self.formel.c.wert ** self.formel.x.wert)))**(1/self.formel.z.wert),
                    self.get_dicts()]

        def solve_to_b(self):
            return [((self.formel.i.wert - self.formel.d.wert * self.formel.e.wert * self.formel.f.wert
                      - self.formel.g.wert)/((self.formel.a.wert ** self.formel.z.wert)
                                             * (self.formel.c.wert ** self.formel.x.wert)))**(1/self.formel.y.wert),
                    self.get_dicts()]

        def solve_to_c(self):
            return [((self.formel.i.wert - self.formel.d.wert * self.formel.e.wert * self.formel.f.wert
                      - self.formel.g.wert)/((self.formel.b.wert ** self.formel.y.wert)
                                             * (self.formel.a.wert ** self.formel.z.wert)))**(1/self.formel.x.wert),
                    self.get_dicts()]

        def solve_to_d(self):
            return [(self.formel.i.wert - self.formel.g.wert - (self.formel.a.wert**self.formel.z.wert)
                    * (self.formel.b.wert**self.formel.y.wert) * (self.formel.c.wert**self.formel.x.wert))
                    / (self.formel.e.wert * self.formel.f.wert), self.get_dicts()]

        def solve_to_e(self):
            return [(self.formel.i.wert - self.formel.g.wert - (self.formel.a.wert**self.formel.z.wert)
                    * (self.formel.b.wert**self.formel.y.wert) * (self.formel.c.wert**self.formel.x.wert))
                    / (self.formel.d.wert * self.formel.f.wert), self.get_dicts()]

        def solve_to_f(self):
            return [(self.formel.i.wert-self.formel.g.wert-(self.formel.a.wert**self.formel.z.wert)
                     * (self.formel.b.wert**self.formel.y.wert) * (self.formel.c.wert**self.formel.x.wert))
                    / (self.formel.d.wert * self.formel.e.wert), self.get_dicts()]

        def solve_to_g(self):
            return [- ((self.formel.a.wert**self.formel.z.wert) * (self.formel.b.wert**self.formel.y.wert)
                       * (self.formel.c.wert**self.formel.x.wert) + self.formel.d.wert * self.formel.e.wert
                       * self.formel.f.wert - self.formel.i.wert), self.get_dicts()]

        def solve_to_z(self):
            return [math.log((self.formel.i.wert-self.formel.d.wert*self.formel.e.wert
                              * self.formel.f.wert-self.formel.g.wert) / ((self.formel.b.wert**self.formel.y.wert)
                                                                          * (self.formel.c.wert**self.formel.x.wert)),
                             self.formel.a.wert), self.get_dicts()]

        def solve_to_y(self):
            return [math.log((self.formel.i.wert-self.formel.d.wert*self.formel.e.wert
                              * self.formel.f.wert-self.formel.g.wert)/((self.formel.a.wert**self.formel.z.wert)
                                                                        * (self.formel.c.wert**self.formel.x.wert)),
                             self.formel.b.wert), self.get_dicts()]

        def solve_to_x(self):
            return [math.log((self.formel.i.wert-self.formel.d.wert*self.formel.e.wert
                             * self.formel.f.wert-self.formel.g.wert)/((self.formel.a.wert**self.formel.z.wert)
                                                                       * (self.formel.b.wert**self.formel.y.wert)),
                             self.formel.c.wert), self.get_dicts()]
